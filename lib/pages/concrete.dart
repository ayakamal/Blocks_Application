...
class Concrete extends StatefulWidget {
  @override
  _ConcreteState createState() => _ConcreteState();
}
            ...
            child: Column(children: <Widget> [
                ...
                Container(
                  ...
                  child:  RichText(text: TextSpan(style: TextStyle(fontSize:18) ,children: <TextSpan> [
                    TextSpan(text: "Here is the Cement Blocks Description",),
                ] ),),),
